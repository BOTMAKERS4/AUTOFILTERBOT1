...
auth_channel = environ.get('-1002127281946')
...
# url shortner
SHORT_URL = environ.get("https://tulinks.online/")
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'JMDiscussionGroup')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002105059053')).split()]
